...
BINS_SPACE = {
    "theta":     np.linspace(-np.pi, np.pi, 200, dtype=np.float32),
    "theta_dot": np.linspace(-8.0,   8.0,   200, dtype=np.float32),
}
...
def evaluate(pi: PendulumCuda, n_episodes: int = 5, render: bool = False) -> None:
